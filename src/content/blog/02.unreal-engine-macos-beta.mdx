...
Here's how you fix Unreal complaining about Xcode on macOS Sonoma's Public Beta (provided you installed the [Xcode beta](https://developer.apple.com/download/all/?q=Xcode))
